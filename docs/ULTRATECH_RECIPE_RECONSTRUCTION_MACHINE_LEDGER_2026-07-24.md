...
| 机器 | 构造功能件（F） | 运行工艺与产出 | 阶段 | 路线 / 证据标签 | 恢复出口 |
|---|---|---|---|---|---|
| ``ceramic_batch_mixer`` | ``ultratech:iron_bolt`` | `midgame/ceramics/ceramic_batch_mixer` → ultratech:mixed_ceramic_powder, ultratech:ceramic_slurry 500 mB | 16 | `precision_campus` (parallelization, visible_constraint, recovery_outlet) | reject_material_recovery |
...
| ``ceramic_processing_center`` | ``ultratech:iron_bolt`` | `midgame/ceramics/ceramic_processing_center` → ultratech:precision_ceramic_part<br>`midgame/ceramics/ceramic_processing_center_components` → ultratech:ceramic_bearing_component, ultratech:ceramic_insulator<br>`route_variants/precision/direct_sintered_ceramic_finish` → ultratech:precision_ceramic_part | 16 | `precision_campus` (parallelization, visible_constraint, recovery_outlet) | reject_material_recovery |
...
| ``ceramic_slip_casting_machine`` | ``ultratech:iron_bolt`` | `midgame/ceramics/ceramic_slip_casting_machine` → ultratech:ceramic_green_body<br>`route_variants/precision/ceramic_slip_casting_dry_mix_recovery` → ultratech:ceramic_green_body | 16 | `precision_campus` (parallelization, visible_constraint, recovery_outlet) | reject_material_recovery |
...
| 机器 | 构造功能件（F） | 运行工艺与产出 | 阶段 | 路线 / 证据标签 | 恢复出口 |
|---|---|---|---|---|---|
| ``fuel_assembly_machine`` | ``ultratech:steel_pressure_vessel`` | `midgame/nuclear_fuel_cycle/fuel_assembly_machine` → ultratech:uranium_fuel_assembly<br>`midgame/nuclear_fuel_cycle/fuel_assembly_machine_paired_batch` → ultratech:uranium_fuel_assembly x2 | 20 | `nuclear_material_cycle` (closed_loop, recovery_outlet, safety_constraint) | mox_and_vitrified_waste |
| ``fuel_pellet_press`` | ``ultratech:steel_rod`` | `midgame/nuclear_fuel_cycle/fuel_pellet_press` → ultratech:fuel_pellet x4<br>`midgame/nuclear_fuel_cycle/fuel_pellet_press_sealed_batch` → ultratech:fuel_pellet x8 | 20 | `nuclear_material_cycle` (closed_loop, recovery_outlet, safety_constraint) | mox_and_vitrified_waste |
| ``fuel_pellet_sintering_furnace`` | ``ultratech:steel_rod`` | `midgame/nuclear_fuel_cycle/fuel_pellet_sintering_furnace` → ultratech:sintered_fuel_pellet x4<br>`midgame/nuclear_fuel_cycle/fuel_pellet_sintering_furnace_thermal_batch` → ultratech:sintered_fuel_pellet x8 | 20 | `nuclear_material_cycle` (closed_loop, recovery_outlet, safety_constraint) | mox_and_vitrified_waste |
| ``fuel_rod_assembly_station`` | ``ultratech:steel_pressure_vessel`` | `midgame/nuclear_fuel_cycle/fuel_rod_assembly_station` → ultratech:uranium_fuel_rod<br>`midgame/nuclear_fuel_cycle/fuel_rod_assembly_station_paired_batch` → ultratech:uranium_fuel_rod x2 | 20 | `nuclear_material_cycle` (closed_loop, recovery_outlet, safety_constraint) | mox_and_vitrified_waste |
| ``mox_fuel_assembly_machine`` | ``ultratech:steel_pressure_vessel`` | `midgame/nuclear_fuel_cycle/mox_fuel_assembly_machine` → ultratech:mox_fuel_assembly<br>`midgame/nuclear_fuel_cycle/mox_fuel_assembly_machine_paired_batch` → ultratech:mox_fuel_assembly x2 | 20 | `nuclear_material_cycle` (closed_loop, recovery_outlet, safety_constraint) | mox_and_vitrified_waste |
| ``plutonium_conversion_furnace`` | ``ultratech:steel_rod`` | `midgame/nuclear_fuel_cycle/plutonium_conversion_furnace` → ultratech:plutonium_dioxide, ultratech:vitrified_radioactive_waste<br>`midgame/nuclear_fuel_cycle/plutonium_conversion_furnace_buffered_batch` → ultratech:plutonium_dioxide x2, ultratech:vitrified_radioactive_waste x2 | 20 | `nuclear_material_cycle` (closed_loop, recovery_outlet, safety_constraint) | mox_and_vitrified_waste |
...
| ``plutonium_pellet_press`` | ``ultratech:steel_rod`` | `midgame/nuclear_fuel_cycle/plutonium_pellet_press` → ultratech:plutonium_fuel_pellet x4<br>`midgame/nuclear_fuel_cycle/plutonium_pellet_press_sealed_batch` → ultratech:plutonium_fuel_pellet x8 | 20 | `nuclear_material_cycle` (closed_loop, recovery_outlet, safety_constraint) | mox_and_vitrified_waste |
| ``spent_fuel_dissolver`` | ``ultratech:steel_pressure_vessel`` | `midgame/nuclear_fuel_cycle/spent_fuel_dissolver` → ultratech:uranium_plutonium_nitrate_solution 500 mB<br>`midgame/nuclear_fuel_cycle/spent_fuel_dissolver_buffered_batch` → ultratech:uranium_plutonium_nitrate_solution 1000 mB | 20 | `nuclear_material_cycle` (closed_loop, recovery_outlet, safety_constraint) | mox_and_vitrified_waste |
| ``spent_fuel_shear`` | ``ultratech:steel_pressure_vessel`` | `midgame/nuclear_fuel_cycle/spent_fuel_shear` → ultratech:spent_fuel_segments x4<br>`midgame/nuclear_fuel_cycle/spent_fuel_shear_buffered_batch` → ultratech:spent_fuel_segments x8 | 20 | `nuclear_material_cycle` (closed_loop, recovery_outlet, safety_constraint) | mox_and_vitrified_waste |
| ``uranium_acid_leach_tank`` | ``ultratech:steel_pressure_vessel`` | `midgame/nuclear_fuel_cycle/uranium_acid_leach_tank` → ultratech:uranium_tailings, ultratech:uranium_sulfate_solution 500 mB<br>`midgame/nuclear_fuel_cycle/uranium_acid_leach_tank_buffered_batch` → ultratech:uranium_tailings x2, ultratech:uranium_sulfate_solution 1000 mB | 20 | `nuclear_material_cycle` (closed_loop, recovery_outlet, safety_constraint) | mox_and_vitrified_waste |
| ``uranium_ball_mill`` | ``ultratech:steel_rod`` | `midgame/nuclear_fuel_cycle/uranium_ball_mill` → ultratech:uranium_ore_powder x2<br>`midgame/nuclear_fuel_cycle/uranium_ball_mill_buffered_batch` → ultratech:uranium_ore_powder x4 | 20 | `nuclear_material_cycle` (closed_loop, recovery_outlet, safety_constraint) | mox_and_vitrified_waste |
| ``uranium_calcination_furnace`` | ``ultratech:steel_rod`` | `midgame/nuclear_fuel_cycle/uranium_calcination_furnace` → ultratech:uranium_trioxide<br>`midgame/nuclear_fuel_cycle/uranium_calcination_furnace_thermal_batch` → ultratech:uranium_trioxide x2 | 20 | `nuclear_material_cycle` (closed_loop, recovery_outlet, safety_constraint) | mox_and_vitrified_waste |
...
| ``uranium_gas_centrifuge`` | ``ultratech:steel_pressure_vessel`` | `midgame/nuclear_fuel_cycle/uranium_gas_centrifuge` → ultratech:uranium_dioxide_powder, ultratech:depleted_uranium_hexafluoride, ultratech:uranium_hexafluoride 75 mB<br>`midgame/nuclear_fuel_cycle/uranium_gas_centrifuge_buffered_batch` → ultratech:uranium_dioxide_powder x2, ultratech:depleted_uranium_hexafluoride x2, ultratech:uranium_hexafluoride 150 mB | 20 | `nuclear_material_cycle` (closed_loop, recovery_outlet, safety_constraint) | mox_and_vitrified_waste |
| ``uranium_ore_crusher`` | ``ultratech:steel_rod`` | `midgame/nuclear_fuel_cycle/uranium_ore_crusher` → ultratech:crushed_uranium_ore x2<br>`midgame/nuclear_fuel_cycle/uranium_ore_crusher_buffered_batch` → ultratech:crushed_uranium_ore x4 | 20 | `nuclear_material_cycle` (closed_loop, recovery_outlet, safety_constraint) | mox_and_vitrified_waste |
| ``uranium_precipitation_tank`` | ``ultratech:steel_pressure_vessel`` | `midgame/nuclear_fuel_cycle/uranium_precipitation_tank` → ultratech:ammonium_diuranate x2<br>`midgame/nuclear_fuel_cycle/uranium_precipitation_tank_buffered_batch` → ultratech:ammonium_diuranate x4 | 20 | `nuclear_material_cycle` (closed_loop, recovery_outlet, safety_constraint) | mox_and_vitrified_waste |
...
| ``petroleum_delayed_coker`` | ``ultratech:steel_pressure_vessel`` | `petroleum/delayed_coke` → ultratech:petroleum_coke, ultratech:petroleum_asphalt 300 mB<br>`route_variants/petrochemical/heavy_oil_coke_recovery` → ultratech:petroleum_coke, ultratech:petroleum_asphalt 200 mB | 12 | `petrochemical_platform` (batch_boundary, logistics_constraint, recovery_outlet) | off_gas_scrubbing |
...
| ``petroleum_polyethylene_kettle`` | ``ultratech:steel_pressure_vessel`` | `petroleum/polyethylene` → ultratech:polyethylene_pellet_petro x2<br>`route_variants/petrochemical/renewable_ethylene_polyethylene_recovery` → ultratech:polyethylene_pellet_petro | 12 | `petrochemical_platform` (batch_boundary, logistics_constraint, recovery_outlet) | off_gas_scrubbing |
...
| 机器 | 构造功能件（F） | 运行工艺与产出 | 阶段 | 路线 / 证据标签 | 恢复出口 |
|---|---|---|---|---|---|
| ``bearing_assembler`` | ``ultratech:iron_bolt`` | `route_variants/standard/powder_bearing_assembly` → ultratech:bearing_assembly<br>`standard_industry/bearing_assembly` → ultratech:bearing_assembly | 8 | `standard_parts_backbone` (automation_exit, first_consumer, parallelization) | scrap_remelt |
...
| ``gear_grinding_machine`` | ``ultratech:iron_bolt`` | `route_variants/standard/powder_gear_precision_finish` → ultratech:precision_gear<br>`standard_industry/precision_gear` → ultratech:precision_gear<br>`standard_industry/ultra_precision_gear` → ultratech:ultra_precision_gear | 8 | `standard_parts_backbone` (automation_exit, first_consumer, parallelization) | scrap_remelt |
...
| ``precision_grinder`` | ``ultratech:steel_rod`` | `route_variants/standard/direct_high_precision_shaft_recovery` → ultratech:high_precision_shaft<br>`standard_industry/high_precision_shaft` → ultratech:high_precision_shaft<br>`standard_industry/precision_shaft` → ultratech:precision_shaft | 8 | `standard_parts_backbone` (automation_exit, first_consumer, parallelization) | scrap_remelt |
...
| ``threading_machine`` | ``ultratech:iron_bolt`` | `route_variants/standard/direct_cut_threaded_fastener` → ultratech:threaded_fastener x2<br>`standard_industry/threaded_fastener` → ultratech:threaded_fastener x2 | 8 | `standard_parts_backbone` (automation_exit, first_consumer, parallelization) | scrap_remelt |
