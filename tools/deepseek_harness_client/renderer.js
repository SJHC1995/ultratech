...
const strings = {
  zh: {
    ...
    welcomeStepOne: '确认本地服务', welcomeStepOneDesc: '若系统缺少 DSH Web，程序会自动下载并启动。',
  ...
  en: {
    ...
    welcomeStepOne: 'Confirm local service', welcomeStepOneDesc: 'The client downloads DSH Web when needed, then starts it automatically.',
